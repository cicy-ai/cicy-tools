...
```text
heartbeat=running version=1.0.0 pid=123 gpu=[Tesla T4, 2 MiB, 15360 MiB] cpu=2cores memory=1.0Gi/12Gi disk=21G/108G(19%) log=/content/gpu-heartbeat.log
```
...
当 Notebook 第一个 Cell 严格等于 heartbeat 命令时，扩展会自动点击一次 Run。安装方法见目录内的 [`README.md`](chrome-colab-heartbeat/README.md)。
